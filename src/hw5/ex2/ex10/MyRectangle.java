...
public class MyRectangle {
    ...
    public double getArea() {
        double rectang1 = topLeftVertex.distance(topRightVertex);
        double rectang2 = topLeftVertex.distance(botLeftVertex);
        return rectang1 * rectang2;
    }

    public double getPerimeter() {
        double rectang1 = topLeftVertex.distance(topRightVertex);
        double rectang2 = topLeftVertex.distance(botLeftVertex);
        return 2 * (rectang1 + rectang2);
    }
